...
public class TesisJpaController extends GenericJpaController<Tesis> implements Serializable {
    ...
    public List<Tesis> listTesis() throws Exception {
        ...
        try {
            ...
            Query q = em.createQuery("select distinct t from Tesis t join fetch t.autoresCollection  left join fetch t.codirectoresCollection left join fetch t.tutoresCollection left join fetch t.proyectosCollection order by t.fechaFin desc, t.nombre asc");
